...
//--------------------------------------------------------------------------------
std::pair<bool, unsigned int> check_visibility(const std::vector<std::string> &forrest, const std::pair<int, int> location) {
    // Sideways
...
int main() {
    ...
    std::cout << "Part 1: " << visible_trees_count << " trees are visible" << std::endl;
